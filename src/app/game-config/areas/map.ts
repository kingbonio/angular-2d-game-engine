...
export default {
      ...
      3: {
            ...
            east: null,
            south: { direction: Direction.S, destination: 2, status: AreaExitStatus.open, itemReferenceNeeded: "", keyColourNeeded: "" },
            west: null,
      } as IAreaExits,
      4: {
            north: { direction: Direction.N, destination: 5, status: AreaExitStatus.closed, itemReferenceNeeded: "", keyColourNeeded: "" },
            east: null,
            south: { direction: Direction.S, destination: 3, status: AreaExitStatus.open, itemReferenceNeeded: "", keyColourNeeded: "" },
            west: null,
      } as IAreaExits,
      5: {
            ...
            east: null,
            south: { direction: Direction.S, destination: 4, status: AreaExitStatus.open, itemReferenceNeeded: "", keyColourNeeded: "" },
            west: null,
      } as IAreaExits,
      6: {
            north: null,
            east: null,
            south: { direction: Direction.S, destination: 5, status: AreaExitStatus.open, itemReferenceNeeded: "65a25063-4303-47b6-bdbe-0ce239396e0d", keyColourNeeded: "red" },
            west: null,
      } as IAreaExits,
};
